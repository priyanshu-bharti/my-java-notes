...
4. [Collection Framework](#collection-framework)
   1. [Arrays](#arrays)
   2. [String](#string)
...
| Fact                                | Explanation                                        |
| ----------------------------------- | -------------------------------------------------- |
| Integer caching                     | -128 to 127 are cached, others are not.            |
| new Integer(n) creates new objects  | Use Integer.valueOf(n) instead.                    |
| Wrapper types can be null           | Can cause NullPointerException.                    |
| Autoboxing is slow                  | Adds memory and CPU overhead.                      |
| Wrapper classes are immutable       | Operations create new objects.                     |
| Double.NaN != Double.NaN            | Use Double.isNaN() instead.                        |
| parseInt() vs valueOf()             | parseInt() returns int, valueOf() returns Integer. |
